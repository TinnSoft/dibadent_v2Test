  ...
  <div>
    <q-td>
      ...
      <template v-if="isTaxArray==false">
        <br />
        <strong style="color: gray;">IMPUESTOS:</strong>
      </template>
      <template v-if="isTaxArray==true">
        <strong v-for="tax in taxes" :key="tax.name">
          <br />
          <strong style="color: gray;">{{tax.name}}:</strong>
        </strong>
      </template>
      <br />
    ...
    <q-td>
      ...
      <template v-if="isTaxArray==false">
        <br />
        <strong style="color: gray;">{{currencyFormat(taxes)}}</strong>
      </template>
      <template v-if="isTaxArray==true">
        <strong v-for="tax in taxes" :key="tax.name">
          <br />
          <strong style="color: gray;">{{currencyFormat(tax.total)}}</strong>
        </strong>
      </template>
      <br />
      <strong style="color: green;">{{currencyFormat(total)}}</strong>
    </q-td>
  </div>
</template>
